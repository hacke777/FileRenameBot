...
@Shakthi963.on_message(pyrogram.filters.command(["start"]))
    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Channel', url='https://t.me/Shakthi963'),
                    InlineKeyboardButton('Feedback', url='https://t.me/XD_Pavan')
                ],
                [
                    InlineKeyboardButton('Other Bots', url='https://t.me/Shakthi963/'),
                    InlineKeyboardButton('about', url='@shakthi963')
                ]
            ]
        ),
